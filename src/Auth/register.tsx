    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-secondary/60 mt-2 text-sm">Start your government exam preparation journey</p>
        </div>
        ...
        <div className="bg-card border border-border/50 rounded-2xl p-6 shadow-sm">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-3 text-secondary/50">or sign up with email</span>
            </div>
          </div>
          ...
          <p className="mt-5 text-center text-sm text-secondary/60">
            ...
            <Link to="/login" className="text-primary hover:text-primary-hover font-semibold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
